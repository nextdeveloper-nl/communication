...
class AbstractAvailableChannelsTransformer extends AbstractTransformer
{
    ...
    public function includeActions(AvailableChannels $model)
    {
    ...
    public function includeMedia(AvailableChannels $model)
    {
    ...
    public function includeSocialMedia(AvailableChannels $model)
    {
    ...
    public function includeComments(AvailableChannels $model)
    {
    ...
    public function includeVotes(AvailableChannels $model)
    {
    ...
    public function includeMeta(AvailableChannels $model)
    {
    ...
    public function includePhoneNumbers(AvailableChannels $model)
    {
    ...
    public function includeAddresses(AvailableChannels $model)
    {
