...
/**
 * Class MessageEventsTransformer. This class is being used to manipulate the data we are serving to the customer
 *
...
class AbstractMessageEventsTransformer extends AbstractTransformer
{
    ...
    public function includeActions(MessageEvents $model)
    {
    ...
    public function includeMedia(MessageEvents $model)
    {
    ...
    public function includeSocialMedia(MessageEvents $model)
    {
    ...
    public function includeComments(MessageEvents $model)
    {
    ...
    public function includeVotes(MessageEvents $model)
    {
    ...
    public function includeMeta(MessageEvents $model)
    {
    ...
    public function includePhoneNumbers(MessageEvents $model)
    {
    ...
    public function includeAddresses(MessageEvents $model)
    {
