...
class AbstractThreadsTransformer extends AbstractTransformer
{
    ...
    public function includeActions(Threads $model)
    {
    ...
    public function includeMedia(Threads $model)
    {
    ...
    public function includeSocialMedia(Threads $model)
    {
    ...
    public function includeComments(Threads $model)
    {
    ...
    public function includeVotes(Threads $model)
    {
    ...
    public function includeMeta(Threads $model)
    {
    ...
    public function includePhoneNumbers(Threads $model)
    {
    ...
    public function includeAddresses(Threads $model)
    {
