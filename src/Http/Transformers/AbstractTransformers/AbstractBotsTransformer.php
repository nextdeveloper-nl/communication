...
class AbstractBotsTransformer extends AbstractTransformer
{
    ...
    public function includeActions(Bots $model)
    {
    ...
    public function includeMedia(Bots $model)
    {
    ...
    public function includeSocialMedia(Bots $model)
    {
    ...
    public function includeComments(Bots $model)
    {
    ...
    public function includeVotes(Bots $model)
    {
    ...
    public function includeMeta(Bots $model)
    {
    ...
    public function includePhoneNumbers(Bots $model)
    {
    ...
    public function includeAddresses(Bots $model)
    {
