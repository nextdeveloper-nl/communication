...
class AbstractUnsubscribesTransformer extends AbstractTransformer
{
    ...
    public function includeActions(Unsubscribes $model)
    {
    ...
    public function includeMedia(Unsubscribes $model)
    {
    ...
    public function includeSocialMedia(Unsubscribes $model)
    {
    ...
    public function includeComments(Unsubscribes $model)
    {
    ...
    public function includeVotes(Unsubscribes $model)
    {
    ...
    public function includeMeta(Unsubscribes $model)
    {
    ...
    public function includePhoneNumbers(Unsubscribes $model)
    {
    ...
    public function includeAddresses(Unsubscribes $model)
    {
