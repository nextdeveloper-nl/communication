...
class AbstractSmtpServersTransformer extends AbstractTransformer
{
    ...
    public function includeActions(SmtpServers $model)
    {
    ...
    public function includeMedia(SmtpServers $model)
    {
    ...
    public function includeSocialMedia(SmtpServers $model)
    {
    ...
    public function includeComments(SmtpServers $model)
    {
    ...
    public function includeVotes(SmtpServers $model)
    {
    ...
    public function includeMeta(SmtpServers $model)
    {
    ...
    public function includePhoneNumbers(SmtpServers $model)
    {
    ...
    public function includeAddresses(SmtpServers $model)
    {
