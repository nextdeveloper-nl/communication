...
class MessagesCreateRequest extends AbstractFormRequest
{
    ...
    public function rules()
    {
        ...
        'sent_by_user_id' => 'nullable|exists:iam_users,uuid|uuid',
        'sent_by_bot_id' => 'nullable|exists:communication_bots,uuid|uuid',
