...
Route::prefix('available-channels')->group(function () {
...
Route::prefix('smtp-servers')->group(function () {
...
Route::prefix('contact-identifiers')->group(function () {
...
Route::prefix('thread-assignments')->group(function () {
...
Route::prefix('message-events')->group(function () {
...
Route::prefix('unsubscribes')->group(function () {
...
Route::prefix('remindables')->group(function () {
