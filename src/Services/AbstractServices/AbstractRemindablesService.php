...
use NextDeveloper\Communication\Events\Remindables\RemindablesCreatedEvent;
use NextDeveloper\Communication\Events\Remindables\RemindablesCreatingEvent;
use NextDeveloper\Communication\Events\Remindables\RemindablesUpdatedEvent;
 ...
 */
class AbstractRemindablesService
{
    public static function get(RemindablesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new RemindablesQueryFilter(new Request());
        }
        ...
        $model = Remindables::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Remindables
    {
        return Remindables::findByRef($ref);
    }
     ...
     *
     * @param  $id
     * @return Remindables|null
     */
    public static function getById($id) : ?Remindables
    {
        return Remindables::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = Remindables::where('uuid', $uuid)->first();
