 ...
 */
class AbstractChannelsService
{
    public static function get(ChannelsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ChannelsQueryFilter($request);
        }
     ...
     */
    public static function getById($id) : ?Channels
    {
        return Channels::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = Channels::where('uuid', $uuid)->first();
     ...
     * @return Channels
     */
    public static function updateRaw(array $data) : ?Channels
    {
    ...
    {
        $model = Channels::where('uuid', $id)->first();
