...
class BotsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Communication\Bots', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Communication\Bots', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Communication\Bots', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Communication\Bots', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Communication\Bots', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Communication\Bots', $model);
    }
