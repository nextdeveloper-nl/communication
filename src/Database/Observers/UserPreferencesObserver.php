...
class UserPreferencesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Communication\UserPreferences', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Communication\UserPreferences', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Communication\UserPreferences', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Communication\UserPreferences', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Communication\UserPreferences', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Communication\UserPreferences', $model);
    }
