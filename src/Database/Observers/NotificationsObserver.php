...
class NotificationsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Communication\Notifications', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Communication\Notifications', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Communication\Notifications', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Communication\Notifications', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Communication\Notifications', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Communication\Notifications', $model);
    }
