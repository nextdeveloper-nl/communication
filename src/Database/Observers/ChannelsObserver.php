...
class ChannelsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Communication\Channels', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Communication\Channels', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Communication\Channels', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Communication\Channels', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Communication\Channels', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Communication\Channels', $model);
    }
